            ...
            for (int attempt = 1; attempt <= maxAttempts; attempt++)
            {
                ...
                try
                {
                    ...
                    StructuredLlmResponse response = await SendStructuredWithDiagnosticsAsync(
                            ...
                            promptContract: new PromptProviderContract(PromptProviderOperation.DateeResponsePlanReconciliation, PromptContractRoleScope.Datee, new[] { promptDocuments.System, promptDocuments.User }, context.PromptFactAccessDecisions))
                        .ConfigureAwait(false);
