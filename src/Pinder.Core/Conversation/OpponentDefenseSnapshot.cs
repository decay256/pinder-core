...
{
    /// <summary>
    /// Snapshot of the opponent's defense posture at the start of a turn.
    ...
    public sealed class OpponentDefenseSnapshot
    {
        ...
        public OpponentDefenseSnapshot(IReadOnlyDictionary<StatType, OpponentDefenseEntry> byAttackerStat)
        {
    ...
    ///
    /// <para>
    /// <see cref="EffectiveModifier"/> = <c>opponent.Stats.GetEffective(DefendingStat)</c>
    /// plus any active <see cref="Pinder.Core.Traps.TrapEffect.OpponentDCIncrease"/> bonus
    ...
    ///
    /// <para>
    /// <see cref="BaseModifier"/> = raw <c>opponent.Stats.GetBase(DefendingStat)</c>
    ...
    {
        /// <summary>
        /// The opponent's stat that defends against the attacker stat.
        ...
        /// active <see cref="Pinder.Core.Traps.TrapEffect.OpponentDCIncrease"/>
        ...
        public OpponentDefenseEntry(StatType defendingStat, int effectiveModifier, int baseModifier)
        {
