...
{
    internal static class AgentJournalAdapterTestRecords
    {
        ...
        private static AgentJournalInputDocument Document(string documentId, string text, params AgentJournalProvenanceRange[] ranges)
            => new AgentJournalInputDocument(documentId, AgentJournalInputRole.System, text, ranges);

        private static AgentJournalProvenanceRange Range(string documentId, int start, int end)
