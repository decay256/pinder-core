    ...
    public sealed class Issue1423_EmotionalDirectorV2Tests
    {
        ...
        public async Task DateeDuplicateVisibleMessage_ReusesDirectorAndRetriesWithRepairPrompt()
        {
            var transport = new RecordingTransport(
                ...
                DateeJson("that lands softer than i expected."),
                DateeJson("A new visible reply with a different move."));
        ...
        {
            var transport = new RecordingTransport(ValidDirectionJson(), DateeJson("A fresh visible answer."));
        ...
        public async Task DateePerformanceDiagnostics_RetainAllV2RuntimeProvenanceKeys()
        {
            ...
            var adapter = CreateAdapter(
                new RecordingTransport(ValidDirectionJson(), DateeJson("A fresh visible answer.")),
        ...
        private static string DateeJson(string message)
        {
            return new JObject
            {
        ...
        private sealed class PhaseRecordingTransport : ILlmTransport, IConversationLlmTransport, IStructuredLlmTransport, IStructuredConversationLlmTransport
        {
                ...
                CancellationToken ct = default)
            {
                ...
                return new StructuredLlmResponse(response, provider: "test", model: "test-model");
            }
        ...
        private sealed class RecordingTransport : ILlmTransport, IStructuredLlmTransport
        {
