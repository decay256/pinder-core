...
namespace Pinder.Core.Tests
{
    ...
    public class GameSessionTrapTaintTests
    {
        ...
        public async Task ResolveTurnAsync_WithPreExistingTrap_PassesInstructionsToDeliveryAndOpponentContexts()
        {
            ...
            // Note: trap was activated during RollEngine.Resolve, then AdvanceTurn decrements.
            // The instruction gathering happens AFTER AdvanceTurn, so the trap should still
            // be active (duration=5, after 1 decrement => 4 turns remaining).
