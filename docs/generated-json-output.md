...
- Validation: the call site owns the schema/contract check after extraction. For example, therapist diagnosis generation deserializes the extracted object and then validates the required cognitive-subtext fields.
