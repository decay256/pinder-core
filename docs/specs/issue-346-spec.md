...
- Charm attacks, opponent defends with SA: DC = 13 + 2 = 15. Player mod = +4. Need = 11. SuccessChance = 0.50
- Rizz attacks, opponent defends with Wit: DC = 13 + 1 = 14. Player mod = +1. Need = 13. SuccessChance = 0.40
- Honesty attacks, opponent defends with Chaos: DC = 13 + 2 = 15. Player mod = +3. Need = 12. SuccessChance = 0.45
- Chaos attacks, opponent defends with Charm: DC = 13 + 2 = 15. Player mod = +2. Need = 13. SuccessChance = 0.40
...
Scores: [
  { OptionIndex: 0, Score: ~6.5,  SuccessChance: 0.50, ExpectedInterestGain: ~0.8, BonusesApplied: [] },
  { OptionIndex: 1, Score: ~3.2,  SuccessChance: 0.40, ExpectedInterestGain: ~0.3, BonusesApplied: [] },
  { OptionIndex: 2, Score: ~5.0,  SuccessChance: 0.45, ExpectedInterestGain: ~0.6, BonusesApplied: ["callback"] },
  { OptionIndex: 3, Score: ~5.8,  SuccessChance: 0.40, ExpectedInterestGain: ~0.5, BonusesApplied: ["tell +2", "combo"] }
]
```
...
6. **Success probability formula:** `need = DC - modifier`, `successChance = max(0.0, min(1.0, (21 - need) / 20.0))`. Natural 20 always succeeds, natural 1 always fails — captured by the clamp. Consumers (e.g. #351 display) convert to percentage via `Math.Round(successChance * 100)`.
